...
- (void)viewDidLoad
{
    ...
    meetBtn = [FinderView setButtonWithFrame:CGRectMake(0, 0, 102, 102) center:CGPointMake(154, 219+startX) backgroundNormalImage:@"meet_normal" backgroundHighlightImage:@"meet_click" setTitle:nil nextImage:@"meet2_normal" nextImage:@"meet2_click"];
...
//    [dynamicBtn setBackgroundImage:KUIImage(@"friendp_click") forState:UIControlStateHighlighted];
    ...
    nearByBtn = [FinderView setButtonWithFrame:CGRectMake(0, 0, 41, 41) center:CGPointMake(252, 137+startX) backgroundNormalImage:@"nearby_normal" backgroundHighlightImage:@"nearby_click" setTitle:@"附近" nextImage:nil nextImage:nil];
    ...
    girlBtn = [FinderView setButtonWithFrame:CGRectMake(0, 0, 56, 56) center:CGPointMake(262, 251+startX) backgroundNormalImage:@"girl_normal" backgroundHighlightImage:@"girl_click" setTitle:@"魔女榜" nextImage:nil nextImage:nil];
